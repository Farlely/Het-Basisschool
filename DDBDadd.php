...
if(isset($_POST['btn_submit'])){
   ...
   if(!empty($naam)){
     try{
      $stmt = $con->prepare("INSERT INTO Docent(Naam, Achternaam, GroepCode) VALUES(:naam, :achternaam, :groep)");
